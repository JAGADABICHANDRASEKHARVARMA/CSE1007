...
class BankAccount
{
    ...
    public void transfer(double amount, com.JAVACSE1007.LABDA4.BankAccount other)
    {
        withdraw(amount);
        other.deposit(amount);
    }
}
class SavingsAccount extends com.JAVACSE1007.LABDA4.BankAccount
{
...
class SavingsCalculatorFrame extends JFrame {
    ...
    private com.JAVACSE1007.Lab11Nov.BankAccount account;
    ...
    public SavingsCalculatorFrame() {
        account = new com.JAVACSE1007.Lab11Nov.BankAccount();
        createTextField();
        createButton();
        createPanel();
        setSize(300, 300);
    ...
    private void createButton() {
        ...
        class AddCalculateListener implements ActionListener {
            public void actionPerformed(ActionEvent event) {
                ...
                account = new com.JAVACSE1007.Lab11Nov.BankAccount(balance);
                rate = rate / 100;
...
class SavingsCalculator
{
    ...
    {
        JFrame frame = new com.JAVACSE1007.LABDA4.SavingsCalculatorFrame();
